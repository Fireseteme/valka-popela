...
- **Čtvercová mřížka otočená „na koso" (od v0.21)** — pole jsou na obrazovce
  kosočtverce a celý svět je velký diamant, přesně jako v předloze. Čtverec
  **35×35 (1225 polí)**; hlavní města frakcí sedí uprostřed čtyř hran světa
  (na obrazovce ve čtyřech rozích diamantu), 16 polí od středu. Armáda se
  pohybuje na 4 sousední pole (přes hrany), vzdálenosti se počítají po
  krocích (Manhattan).
...
- **Izometrická grafika**: mapa je od v0.16 **skutečná 3D scéna** (three.js,
  ...
  **Každá frakce má svůj biom** v kvadrantu kolem svého hlavního města:
  ...
  a sopky s lávou. Střed za hradbami je **popel Vellaru** (bledé duny,
